...
const translations = {
  ...
  "ai.layerZoneTip": { fi: "🧤 Suosi tänään kerrospukeutumista. Ohut villakerros väliin pitää lapsen lämpimänä ilman hikoilua.", sv: "🧤 Föredra lagerklädsel idag. Ett tunt ullager emellan håller barnet varmt utan att svettas.", en: "🧤 Layer up today. A thin wool layer in between keeps the child warm without sweating." },
   ...
   "ai.springTip": { fi: "☀️ Kevätaurinko alkaa jo lämmittää! Vaikka lämpötila on nollan tuntumassa, välikausivaatteet hyvällä välikerroksella ovat nyt paras valinta aktiiviseen ulkoiluun.", sv: "☀️ Vårsolen börjar redan värma! Även om temperaturen är runt noll är mellansäsongskläder med ett bra mellanlager nu det bästa valet för aktiv utevistelse.", en: "☀️ The spring sun is starting to warm things up! Even though it is around zero degrees, mid-season gear with a good mid-layer is now the best choice for active play." },
...
const clothingDescMap: Record<string, { sv: string; en: string }> = {
  ...
  "Kevyet kengät": { sv: "Lätta skor", en: "Light shoes" },

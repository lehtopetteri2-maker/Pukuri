...
const translations = {
  ...
  "footer.privacyS1": { fi: "Pukuri-sovellus", sv: "Pukuri-appen", en: "Pukuri app", et: "Pukuri rakendus", ar: "تطبيق Pukuri" },
  "footer.privacyS2Title": { fi: "2. Kerättävät tiedot", sv: "2. Insamlade uppgifter", en: "2. Data Collected", et: "2. Kogutavad andmed", ar: "2. البيانات المجمعة" },
  "footer.privacyS2": { fi: "Sovellus tallentaa paikallisesti (selaimen LocalStorage) käyttäjän valitseman kaupungin, ikäryhmävalinnan sekä viikko-ohjelmakuvan. Tietoja ei lähetetä ulkoisille palvelimille.", sv: "Appen sparar lokalt (webbläsarens LocalStorage) användarens valda stad, åldersgrupp och veckoschemabild. Inga uppgifter skickas till externa servrar.", en: "The app stores locally (browser LocalStorage) the selected city, age group, and weekly schedule image. No data is sent to external servers.", et: "Rakendus salvestab lokaalselt (brauseri LocalStorage) kasutaja valitud linna, vanuserühma ja nädala ajakava pildi. Andmeid ei saadeta välistele serveritele.", ar: "يخزن التطبيق محلياً (LocalStorage في المتصفح) المدينة المختارة والفئة العمرية وصورة الجدول الأسبوعي. لا يتم إرسال بيانات لخوادم خارجية." },
  ...
  "footer.privacyS3": { fi: "Tallennettuja tietoja käytetään ainoastaan sovelluksen toiminnallisuuden tarjoamiseen, kuten pukeutumissuositusten näyttämiseen ja viikko-ohjelman säilyttämiseen.", sv: "Sparade uppgifter används enbart för att tillhandahålla appens funktionalitet, som att visa klädrekommendationer och spara veckoschemat.", en: "Stored data is used solely for providing app functionality, such as displaying clothing recommendations and saving the weekly schedule.", et: "Salvestatud andmeid kasutatakse ainult rakenduse funktsionaalsuse tagamiseks, nagu riietussoovituste kuvamine ja nädala ajakava salvestamine.", ar: "تُستخدم البيانات المخزنة فقط لتوفير وظائف التطبيق، مثل عرض توصيات الملابس وحفظ الجدول الأسبوعي." },
  "footer.privacyS4Title": { fi: "4. Evästeet ja analytiikka", sv: "4. Cookies och analys", en: "4. Cookies & Analytics", et: "4. Küpsised ja analüütika", ar: "4. ملفات تعريف الارتباط والتحليلات" },
  "footer.privacyS4": { fi: "Sovellus ei käytä kolmannen osapuolen evästeitä. Mahdolliset mainoslinkit (affiliate-linkit) voivat ohjata ulkoisille sivustoille, joilla on omat tietosuojakäytäntönsä.", sv: "Appen använder inga tredjepartscookies. Eventuella annonslänkar (affiliatelänkar) kan leda till externa webbplatser med egna integritetspolicyer.", en: "The app does not use third-party cookies. Affiliate links may redirect to external sites with their own privacy policies.", et: "Rakendus ei kasuta kolmanda osapoole küpsiseid. Reklaamlingid võivad suunata välistele veebilehtedele, millel on oma privaatsuspoliitika.", ar: "لا يستخدم التطبيق ملفات تعريف ارتباط الطرف الثالث. قد تعيد الروابط التابعة التوجيه لمواقع خارجية لها سياسات خصوصية خاصة." },
  "footer.privacyS5Title": { fi: "5. Tietojen poistaminen", sv: "5. Radering av uppgifter", en: "5. Data Deletion", et: "5. Andmete kustutamine", ar: "5. حذف البيانات" },
  "footer.privacyS5": { fi: "Käyttäjä voi poistaa kaikki tallentamansa tiedot tyhjentämällä selaimen LocalStorage-tiedot selaimen asetuksista.", sv: "Användaren kan radera alla sparade uppgifter genom att rensa webbläsarens LocalStorage-data i webbläsarens inställningar.", en: "Users can delete all stored data by clearing the browser's LocalStorage in browser settings.", et: "Kasutaja saab kõik salvestatud andmed kustutada, tühjendades brauseri seadetes LocalStorage'i.", ar: "يمكن للمستخدمين حذف جميع البيانات المخزنة عن طريق مسح LocalStorage في إعدادات المتصفح." },
  "footer.privacyS6Title": { fi: "6. Yhteydenotto", sv: "6. Kontakt", en: "6. Contact", et: "6. Kontakt", ar: "6. الاتصال" },
  "footer.privacyS6": { fi: "Palautetta ja tietosuojaa koskevia kysymyksiä voit lähettää sähköpostitse:", sv: "Feedback och frågor om integritetspolicyn kan skickas via e-post:", en: "Feedback and privacy-related questions can be sent via email:", et: "Tagasisidet ja privaatsusküsimusi saab saata e-postiga:", ar: "يمكن إرسال الملاحظات والأسئلة المتعلقة بالخصوصية عبر البريد الإلكتروني:" },

        ...
        <DialogContent className="max-w-lg max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p>
                Sovellus tallentaa paikallisesti (selaimen LocalStorage) käyttäjän valitseman kaupungin, 
                ikäryhmävalinnan sekä viikko-ohjelmakuvan. Tietoja ei lähetetä ulkoisille palvelimille.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Tallennettuja tietoja käytetään ainoastaan sovelluksen toiminnallisuuden tarjoamiseen, 
                kuten pukeutumissuositusten näyttämiseen ja viikko-ohjelman säilyttämiseen.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Sovellus ei käytä kolmannen osapuolen evästeitä. Mahdolliset mainoslinkit (affiliate-linkit) 
                voivat ohjata ulkoisille sivustoille, joilla on omat tietosuojakäytäntönsä.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Käyttäjä voi poistaa kaikki tallentamansa tiedot tyhjentämällä selaimen LocalStorage-tiedot 
            ...
            <section>
              ...
              <p>
                ...
                <a
                  href="mailto:lehtopetteri@hotmail.com"

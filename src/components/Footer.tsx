      ...
      <Dialog open={privacyOpen} onOpenChange={setPrivacyOpen}>
        <DialogContent className="max-w-lg max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            ...
            <section><h3 className="font-display font-700 text-foreground mb-1">{t("footer.privacyS6Title")}</h3><p>{t("footer.privacyS6")} <a href="mailto:pukuri@outlook.com" className="text-primary underline hover:text-primary/80 transition-colors">pukuri@outlook.com</a></p><p className="mt-2 text-xs text-muted-foreground/70">{t("affiliate.adtraction")}</p></section>
          </div>
        ...
        <DialogContent className="max-w-lg max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p><a href="mailto:pukuri@outlook.com" className="text-primary underline hover:text-primary/80 transition-colors">pukuri@outlook.com</a></p>
            </section>
            <section>

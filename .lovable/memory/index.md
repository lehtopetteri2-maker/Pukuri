...
- i18n: LanguageProvider wraps app, useLanguage() hook, TranslationKey type, localStorage key "pukuri-language", 3 langs: fi/sv/en
...
- Brand: Pukuri, package com.pukuri.app, icon at src/assets/icon.png
